export default function SiteFooter() {
  return (
    <footer className="bg-[#02052d] px-8 py-10 text-white">
      <div className="mx-auto grid max-w-[1540px] items-start gap-10 text-center lg:grid-cols-3 lg:text-left">
          ...
          <div className="mt-5 space-y-3 text-base leading-7">
            <p>
              ...
              <a
                ...
                className="font-medium text-[#f26b2c] underline-offset-4 transition hover:text-orange-300 hover:underline"
              >
        ...
        <div className="text-center">
          ...
          <div className="mt-5 flex justify-center gap-4">
            <a
              ...
              rel="noreferrer"
              aria-label="Facebook"
              className="flex h-12 w-12 items-center justify-center rounded-lg bg-white/10 text-white shadow-lg transition hover:-translate-y-1 hover:bg-[#f26b2c] hover:shadow-orange-950/30"
            >
        ...
        <div className="text-center">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="mt-5 inline-block text-xl font-bold text-[#f26b2c] underline-offset-4 transition hover:text-orange-300 hover:underline"
          >
            Linktree
          </a>
        </div>
